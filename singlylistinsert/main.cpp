/**
 * C program to insert a node beginning of a Singly Linked List
 */
...
int main()
{
    ...
    printf("\nEnter data to insert at beginning of the list: ");// Insert data at the beginning of the singly linked list
    scanf("%d", &data);
